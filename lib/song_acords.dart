...
class SongAcords extends StatefulWidget {
  const SongAcords({Key? key, required this.song, required bool this.ispodbor1})
      : super(key: key);
              ...
              builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
                if (snapshot.hasData) {
                  return Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: List.generate(parser.listsong.length, (index) {
                        ...
                        return Text(
                          parser.listsong[index].replaceAll('  ', '    '),
                          style: mytextstyle,
                        );
                      }),
                    ),
